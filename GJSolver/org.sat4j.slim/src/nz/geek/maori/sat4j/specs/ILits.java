...
import nz.geek.maori.sat4j.core.Propagatable;
...
public interface ILits {
	...
	public abstract IConstr getReason(int lit);

	public abstract void setReason(int lit, IConstr r);
	...
	void initVariables(IVecInt in);

	public abstract int getFreeVariable();
}
