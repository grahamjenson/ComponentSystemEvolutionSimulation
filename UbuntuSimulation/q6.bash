...
for i in `seq 1 50`; 
do 
./gUser.py -u 0.42159 -i 0.7638915 -U"-removed,-new,-stableversion(604800)" -o q6/conservativehighinstall-$i.user
./gUser.py -u 0.18629183 -i 0.08623483 -U"-removed,-new,-stableversion(604800)" -o q6/conservativelowchange-$i.user
